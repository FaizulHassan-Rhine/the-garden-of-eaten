    ...
    <div className=" bg-[#F4F3EF]">
      <footer className="footer container mx-auto lg:justify-items-center py-5 text-black grid lg:grid-cols-4">
        <div className="lg:px-8">
          ...
          <p className="text-sm">
            <span className="font-bold text-[#E21B70] ">Hotline</span>{" "}
            01327-364140
          </p>
         ...
         <p className="text-xs">eat@thegardenofeaten.com</p>
          ...
          <div className="flex text-[#E21B70] gap-2 pt-1">
        ...
        {/* <div className="pt-10">
          <span className="text-lg font-bold text-[#E21B70] ">
            Openig hours
          </span>
        ...
        <div className="flex flex-col mt-5">
          <span className="text-lg font-bold text-[#E21B70] mb-5">Company</span>
        ...
        <div className="flex flex-col mt-5">
          <span className="text-lg font-bold text-[#E21B70] mb-5">Legal</span>
        ...
        <div className="mt-5">
            <p className="pb-5">
            <span className="text-lg font-bold text-[#E21B70] ">Location</span>
            </p>
      ...
      <footer className="footer px-10 py-4 border-t-2 bg-[#F4F3EF]    justify-center ">
        <div className="items-center grid-flow-col">
          <p className="text-center text-sm">
            <span className="text-[#E21B70] ">{`The Garden of Eat'n`}</span> <br />
